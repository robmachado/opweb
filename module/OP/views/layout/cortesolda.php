...
$ces = '<table>
    <tr>
        ...
        <td>
            ...
            <input class="right" type="text" id="csamarnumpc" name="csamarnumpc" value="" size="8" placeholder="00000">
            </td>
            <td width="5px"></td>
            <td>
            <label for="csprodutividade">Produtividade</label><br>
            <input class="right" type="text" id="csprodutividade" name="csprodutividade" value="" size="8" placeholder="00000">pç/min<br>
            <label for="csperdas">Perdas de Processo</label><br>
            <input class="right" type="text" id="csperdas" name="csperdas" value="" size="8" placeholder="00000">%
            </td>
            </tr></table>
        </td>
        <td width="5px"></td>
