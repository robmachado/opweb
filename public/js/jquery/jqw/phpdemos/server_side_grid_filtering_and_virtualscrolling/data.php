<?php
    ...
    if (isset($_GET['filterscount']))
    {
        ...
        if ($filterscount > 0)
        {
            ...
            $query = "SELECT * FROM Orders ".$where." LIMIT $start, $new_total_rows";        
    ...
    {    
        ...
        if ($sortorder != '')
        {
            if ($_GET['filterscount'] == 0)
            {
                if ($sortorder == "desc")
                {
                    $query = "SELECT * FROM Orders ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $total_rows";
                }
                else if ($sortorder == "asc")
                {
                    $query = "SELECT * FROM Orders ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $total_rows";
                }
            }
            else
            {
